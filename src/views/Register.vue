<template>
  <div class="login-wrap">
    <div class="login-box">
      ...
      <h1 class="heading">{{ $t('signUp') }}</h1>
      <el-form :model="account" :rules="rules" ref="validateForm">
        <el-form-item prop="firstName">
          <el-input v-model="account.firstName" :placeholder="$t('firstName')"></el-input>
        </el-form-item>
        <el-form-item prop="lastName">
          <el-input v-model="account.lastName" :placeholder="$t('lastName')"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="password">
          ...
          <el-input v-model="account.passwordRepeat" type="password"
            :placeholder="$t('passwordRepeat')" @keydown.enter.native="onLoginClick">
          </el-input>
        </el-form-item>
        <el-button type="primary" size="large"
          :loading="isLoading"
          @click="onLoginClick">{{ $t('signUp') }}
        </el-button>
      </el-form>
    </div>
  </div>
    ...
    return {
      ...
      rules: {
        firstName: [
          {
            required: true,
            message: this.$t("pleaseEnter") + this.$t("firstName"),
            trigger: "change,blur"
          }
        ],
        lastName: [
          {
            required: true,
            message: this.$t("pleaseEnter") + this.$t("lastName"),
            trigger: "change,blur"
          }
        ],
        username: [
        ...
        passwordRepeat: [
          {
            required: true,
            message: this.$t("pleaseEnter") + this.$t("passwordRepeat"),
            trigger: "change,blur"
          }
        ]
      }
